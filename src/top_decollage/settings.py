...
TRANSITIONS_MODULE = "top_decollage.transitions"
...
# error messages.
DEFAULT_STATE = "top_decollage.states.S001xWelcome"
    ...
    PLATFORMS.append(
        {
            ...
            "greeting": [
                {
                    "locale": "default",
                    "text": "¡Hola {{user_first_name}}! ¿Quieres jugar a un juego?",
                }
            ],
...
CODE_LIVE_RELOAD = False
I18N_LIVE_RELOAD = False
